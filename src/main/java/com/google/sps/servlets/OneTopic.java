  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    if (results.hasNext() == false) {
      ...
      out.println("<div style=\"padding:1%;\">" + "<div>"
          ...
          "<div style=\"text-align:justify; width:100%; font-size:20px;\">" + "<p >" + description + "</p>" + "</div>" +

          "</div>");
      out.println("<h1 style=\"text-align:center; margin-top:10px;\"><a href=\'/index.html\'>Go back</a></h1>");
    }
  }
}
